...
public class DragGap22 : MonoBehaviour
{
	...
	private void CheckWin()
	{
		if (AreObjectsClose(GameObject.Find("Gap1").transform.position, GameObject.Find("TransparentGap1").transform.position)
			...
			&& AreObjectsClose(GameObject.Find("Gap5").transform.position, GameObject.Find("TransparentGap5").transform.position)
			&& AreObjectsClose(GameObject.Find("Gap6").transform.position, GameObject.Find("TransparentGap6").transform.position))
		{
